...
public class JsonPropertySourceFactory implements PropertySourceFactory {
    ...
    private Properties loadJsonProperties(Resource resource) throws IOException {
        // Load JSON properties from the resource and convert them to Properties
        // This is a simplified example, and you may want to use a JSON library for proper parsing
        // e.g., Jackson ObjectMapper or Gson
